...
export const RadarMarker: React.FC<RadarMarkerProps> = ({
	...
	return (
		...
		>
			<Tooltip offset={[15, 0]} opacity={1} permanent className="font-bold">
			...
			{isActive && (
				<Popup autoClose>
					<section className="text-black max-w-52 space-y-2 font-poppins">
						...
						<p>
							<strong>Faixas Fiscalizadas:</strong> {radar.monitoredLanes}
						</p>
						<p>
							<strong>Sentido:</strong> {radar.monitoringDirection}
						</p>
						<p>
							<strong>Identificação:</strong> {radar.equipmentIdentification}
						</p>
						<p>
							<strong>Tipo:</strong> {radar.equipmentType}
						</p>
						<p>
							<strong>Velocidade:</strong> {radar.monitoredSpeed}
						</p>
						<p>
							<strong>VMD:</strong> {radar.vmd.toLocaleString()} veículos/dia
						</p>
						<p>
							<strong>Período VMD:</strong> {radar.vmdPeriod}
						</p>
						<p>
