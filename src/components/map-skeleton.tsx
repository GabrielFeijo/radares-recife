...
export const MapSkeleton: React.FC = () => {
	return (
		<div className="relative w-full h-full min-h-screen bg-slate-100 overflow-hidden select-none animate-pulse">
			...
			{/* Placeholder: Barra de Busca no Topo */}
			...
			{/* Placeholder: Botões de Controle no Topo Direito */}
			...
			{/* Placeholder: Painel Informativo Inferior Esquerdo */}
