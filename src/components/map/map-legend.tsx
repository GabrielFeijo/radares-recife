...
export function MapLegend({
	...
	return (
		<div className="hidden sm:block absolute bottom-[max(1rem,env(safe-area-inset-bottom))] left-3 z-map-ui bg-white px-4 py-3 rounded-2xl shadow-lg border border-slate-200 text-xs">
