export function MapSkeleton() {
	return (
		<div className="relative w-full h-full min-h-screen bg-slate-100 overflow-hidden select-none animate-pulse">
			...
			<div className="absolute top-[40%] left-[52%] w-5 h-5 rounded-full bg-sky-500/30 border border-sky-500/50 shadow-xs" />
			<div className="absolute top-[55%] left-[38%] w-5 h-5 rounded-full bg-amber-500/30 border border-amber-500/50 shadow-xs" />
			<div className="absolute top-[35%] left-[68%] w-5 h-5 rounded-full bg-sky-500/30 border border-sky-500/50 shadow-xs" />
			<div className="absolute top-[65%] left-[75%] w-5 h-5 rounded-full bg-amber-500/30 border border-amber-500/50 shadow-xs" />
