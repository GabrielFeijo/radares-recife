...
export function SpeedFilterPanel({
	...
	return (
		<div className="absolute top-28 sm:top-16 right-3 z-map-ui bg-white p-3.5 rounded-2xl shadow-xl border border-slate-200 flex flex-col gap-1.5 min-w-56 text-xs animate-in fade-in zoom-in-95 duration-150">
